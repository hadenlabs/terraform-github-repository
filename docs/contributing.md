...
Documentation is a part of the terraform-github-repository code base. You can find the documentation files in the `doc/` subdirectory of the [main repository](https://github.com/hadenlabs/terraform-github-repository). This means that the contribution process is the same for both the source code and documentation.
...
- Any [Pull Request](https://github.com/hadenlabs/terraform-github-repository/pulls) should be closed or merged within a week
