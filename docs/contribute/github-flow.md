To contribute to terraform-github-repository project on [GitHub](https://github.com/hadenlabs/terraform-github-repository), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/terraform-github-repository/pulls).
...
To follow the instructions in this guide and start contributing to terraform-github-repository project on GitHub:
...
```bash
git remote add upstream  https://github.com/hadenlabs/terraform-github-repository.git
```

Now your **upstream** points to **hadenlabs/terraform-github-repository**.
...
git fetch upstream # assuming upstream is hadenlabs/terraform-github-repository
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/terraform-github-repository/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
